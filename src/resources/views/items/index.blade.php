...
<div class="ml-64 px-6 py-8 space-y-10">
    ...
    <div class="bg-white border rounded shadow p-6">
        ...
        <canvas id="stackedChartCanvas" height="300"></canvas>
    </div>

    {{-- ▼ 原因の表 --}}
    <div class="bg-white border rounded shadow">
        <div class="bg-gray-400 text-white px-4 py-2 flex justify-between">
            <span class="font-semibold">発生事象</span>
            <div class="text-sm">
                評価を選択
                <select disabled class="bg-white text-black border ml-2 px-2 py-1 rounded">
