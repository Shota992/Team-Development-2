    ...
    <aside class="w-56 h-screen bg-white shadow-lg fixed overflow-y-auto">
        ...
        <div class="p-4 border-b bg-gray-100">
            ...
            <div class="flex items-center justify-center gap-8">
                <img src="images/bellicon.png" alt="Bell" class="w-6 h-6">
                <img src="images/logouticon.png" alt="Logout" class="w-6 h-6">
            </div>
        </div>
        <nav>
            <ul>
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <a href="#" class="flex items-center space-x-2 text-gray-700">
                        <img src="images/dashboardicon.png" class="w-6 h-6" alt="">
                        <span>ダッシュボード</span>
                    </a>
                </li>
                {{-- <li @class([
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 text-gray-700">
                        <img src="/src/public/images/dashboardicon.png" class="w-6 h-6" alt="">
                        <span>ダッシュボード</span>
                    </a>
                </li> --}}
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <a href="#" class="flex items-center space-x-2 text-gray-700">
                        <img src="images/item-detail icon.png" class="w-6 h-6" alt="">
                        <span>項目別詳細</span>
                    </a>
                </li>
                {{-- <li @class([
                    ...
                    <a href="{{ route('detail') }}" class="flex items-center space-x-2 text-gray-700">
                        <img src="/src/public/images/item-detail icon.png" class="w-6 h-6" alt="">
                        <span>項目別詳細</span>
                    </a>
                </li> --}}
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <a href="#" class="flex items-center space-x-2 text-gray-700">
                        <img src="images/dept-compareicon.png" class="w-6 h-6" alt="">
                        <span>部署別比較</span>
                    </a>
                </li>
                {{-- <li @class([
                    ...
                    <a href="{{ route('compare') }}" class="flex items-center space-x-2 text-gray-700">
                        <img src="/src/public/images/dept-compareicon.png" class="w-6 h-6" alt="">
                        <span>部署別比較</span>
                    </a>
                </li> --}}
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <details class="group cursor-pointer">
                        <summary class="flex justify-between items-center text-gray-700">
                            <div class="flex items-center space-x-2">
                                <img src="images/policy-createicon.png" class="w-6 h-6" alt="">
                                <span>施策立案</span>
                            </div>
                ...
                {{-- <li @class([
                    ...
                    <details class="group cursor-pointer" @if(request()->routeIs('measure.*')) open @endif>
                        <summary class="flex items-center space-x-2 text-gray-700">
                            <img src="/src/public/images/policy-createicon.png" class="w-6 h-6" alt="">
                ...
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <details class="group cursor-pointer">
                        <summary class="flex justify-between items-center text-gray-700">
                            <div class="flex items-center space-x-2">
                                <img src="images/policy-listicon.png" class="w-6 h-6" alt="">
                                <span>施策一覧</span>
                            </div>
                            <span class="transition-transform group-open:rotate-90">▶</span>
                        </summary>
                ...
                {{-- <li @class([
                    ...
                    <details class="group cursor-pointer" @if(request()->routeIs('measure.*')) open @endif>
                        <summary class="flex items-center space-x-2 text-gray-700">
                            <img src="/src/public/images/policy-listicon.png" class="w-6 h-6" alt="">
                            <span class="flex-1">施策一覧</span>
                            <span class="ml-auto transition-transform group-open:rotate-90">▶</span>
                        </summary>
                        <ul class="pl-6 mt-4 space-y-1">
                            <li><a href="{{ route('measure.create') }}" class="text-gray-600 hover:text-blue-600">実行タスク一覧</a></li>
                            <li><a href="{{ route('measure.mentor') }}" class="text-gray-600 hover:text-blue-600">評価/改善未対応タスク一覧</a></li>
                            <li><a href="{{ route('measure.deepdive') }}" class="text-gray-600 hover:text-blue-600">評価/改善済みタスク一覧</a></li>
                        </ul>
                    </details>
                </li> --}}
                </li>
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <details class="group cursor-pointer">
                        <summary class="flex justify-between items-center text-gray-700">
                            <div class="flex items-center space-x-2">
                                <img src="images/survey-configiconicon.png" class="w-6 h-6" alt="">
                                <span>アンケート設定</span>
                            </div>
                            <span class="transition-transform group-open:rotate-90">▶</span>
                        </summary>
                ...
                {{-- <li @class([
                    ...
                    <details class="group cursor-pointer" @if(request()->routeIs('survey.*')) open @endif>
                        <summary class="flex items-center space-x-2 text-gray-700">
                            <img src="/src/public/images/survey-configiconicon.png" class="w-6 h-6" alt="">
                ...
                <li class="hover:bg-[#e6f8fe] p-4 rounded">
                    <details class="group cursor-pointer">
                        <summary class="flex justify-between items-center text-gray-700">
                            <div class="flex items-center space-x-2">
                            <img src="images/settingsicon.png" class="w-6 h-6" alt="">
                            <span>設定</span>
                            </div>
                            <span class="transition-transform group-open:rotate-90">▶</span>
                        </summary>
                ...
                {{-- <li @class([
                    ...
                    <details class="group cursor-pointer" @if(request()->routeIs('setting.*')) open @endif>
                        <summary class="flex items-center space-x-2 text-gray-700">
                            <img src="/src/public/images/settingsicon.png" class="w-6 h-6" alt="">
