...
<div class="flex items-center justify-center min-h-screen bg-[#E0F4FF]">
    <div class="w-full max-w-xl bg-white p-8 rounded-md shadow">
        ...
        <h2 class="text-lg text-center font-semibold mb-6">管理者情報入力画面</h2>
        ...
        <form method="POST" action="{{ route('sign-up.admin.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ $admin['name'] ?? old('name') }}" class="w-full p-2 border rounded">
                @error('name')
            ...
            <div class="mb-4">
                ...
                <input type="date" name="birthday" value="{{ $admin['birthday'] ?? old('birthday') }}" class="w-full p-2 border rounded">
                @error('birthday')
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ $admin['email'] ?? old('email') }}" class="w-full p-2 border rounded">
                @error('email')
                    <p class="text-red-500 text-sm">
            ...
            <div class="mt-10 text-center space-y-4">
                <button type="submit"
                        id="submit-next"
                        class="inline-block w-60 py-3 bg-[#4880FF] text-white font-bold rounded-md shadow text-center">
                    次へ
                </button>
            </div>
        </form>
